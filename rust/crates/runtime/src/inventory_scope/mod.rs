...
pub use wire::{
    ...
    decode_generation_advanced, decode_lookup_request, decode_query_request, decode_query_response,
    decode_resnapshot_required, decode_resolve_request, decode_root_published,
    decode_root_unloaded, decode_shard_fallback, encode_bulk_chunk, encode_delta_event,
    encode_discovery_bulk_chunk, encode_discovery_delta_event, encode_fact_block,
    encode_generation_advanced, encode_lookup_request, encode_query_request, encode_query_response,
    encode_resnapshot_required, encode_resolve_request, encode_root_published,
    encode_root_unloaded, encode_shard_fallback, uuid_to_words,
};
