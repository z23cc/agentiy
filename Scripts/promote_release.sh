...
SENTRY_CONNECT_TIMEOUT_SECONDS="${AGENTRY_SENTRY_CONNECT_TIMEOUT_SECONDS:-10}"
SENTRY_REQUEST_TIMEOUT_SECONDS="${AGENTRY_SENTRY_REQUEST_TIMEOUT_SECONDS:-60}"
RELEASE_DOWNLOAD_CONNECT_TIMEOUT_SECONDS="${AGENTRY_RELEASE_DOWNLOAD_CONNECT_TIMEOUT_SECONDS:-10}"
RELEASE_DOWNLOAD_ATTEMPT_TIMEOUT_SECONDS="${AGENTRY_RELEASE_DOWNLOAD_ATTEMPT_TIMEOUT_SECONDS:-120}"
RELEASE_DOWNLOAD_TOTAL_TIMEOUT_SECONDS="${AGENTRY_RELEASE_DOWNLOAD_TOTAL_TIMEOUT_SECONDS:-600}"
...
validate_sentry_network_bounds() {
    validate_bounded_positive_integer AGENTRY_SENTRY_CONNECT_TIMEOUT_SECONDS "$SENTRY_CONNECT_TIMEOUT_SECONDS" 60
    validate_bounded_positive_integer AGENTRY_SENTRY_REQUEST_TIMEOUT_SECONDS "$SENTRY_REQUEST_TIMEOUT_SECONDS" 300
    (( SENTRY_CONNECT_TIMEOUT_SECONDS <= SENTRY_REQUEST_TIMEOUT_SECONDS )) ||
        fail "AGENTRY_SENTRY_CONNECT_TIMEOUT_SECONDS must not exceed AGENTRY_SENTRY_REQUEST_TIMEOUT_SECONDS"
}

validate_release_download_bounds() {
    validate_bounded_positive_integer AGENTRY_RELEASE_DOWNLOAD_CONNECT_TIMEOUT_SECONDS "$RELEASE_DOWNLOAD_CONNECT_TIMEOUT_SECONDS" 60
    validate_bounded_positive_integer AGENTRY_RELEASE_DOWNLOAD_ATTEMPT_TIMEOUT_SECONDS "$RELEASE_DOWNLOAD_ATTEMPT_TIMEOUT_SECONDS" 300
    validate_bounded_positive_integer AGENTRY_RELEASE_DOWNLOAD_TOTAL_TIMEOUT_SECONDS "$RELEASE_DOWNLOAD_TOTAL_TIMEOUT_SECONDS" 1200
    (( RELEASE_DOWNLOAD_CONNECT_TIMEOUT_SECONDS <= RELEASE_DOWNLOAD_ATTEMPT_TIMEOUT_SECONDS )) ||
        fail "AGENTRY_RELEASE_DOWNLOAD_CONNECT_TIMEOUT_SECONDS must not exceed AGENTRY_RELEASE_DOWNLOAD_ATTEMPT_TIMEOUT_SECONDS"
    (( RELEASE_DOWNLOAD_ATTEMPT_TIMEOUT_SECONDS <= RELEASE_DOWNLOAD_TOTAL_TIMEOUT_SECONDS )) ||
        fail "AGENTRY_RELEASE_DOWNLOAD_ATTEMPT_TIMEOUT_SECONDS must not exceed AGENTRY_RELEASE_DOWNLOAD_TOTAL_TIMEOUT_SECONDS"
}
