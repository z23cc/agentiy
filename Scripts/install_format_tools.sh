...
TEMP_DIR=""
FORMAT_DOWNLOAD_CONNECT_TIMEOUT_SECONDS="${AGENTRY_FORMAT_DOWNLOAD_CONNECT_TIMEOUT_SECONDS:-10}"
FORMAT_DOWNLOAD_ATTEMPT_TIMEOUT_SECONDS="${AGENTRY_FORMAT_DOWNLOAD_ATTEMPT_TIMEOUT_SECONDS:-120}"
FORMAT_DOWNLOAD_TOTAL_TIMEOUT_SECONDS="${AGENTRY_FORMAT_DOWNLOAD_TOTAL_TIMEOUT_SECONDS:-300}"
...
validate_download_bounds(){
    validate_bounded_positive_integer AGENTRY_FORMAT_DOWNLOAD_CONNECT_TIMEOUT_SECONDS "$FORMAT_DOWNLOAD_CONNECT_TIMEOUT_SECONDS" 60
    validate_bounded_positive_integer AGENTRY_FORMAT_DOWNLOAD_ATTEMPT_TIMEOUT_SECONDS "$FORMAT_DOWNLOAD_ATTEMPT_TIMEOUT_SECONDS" 300
    validate_bounded_positive_integer AGENTRY_FORMAT_DOWNLOAD_TOTAL_TIMEOUT_SECONDS "$FORMAT_DOWNLOAD_TOTAL_TIMEOUT_SECONDS" 600
    (( FORMAT_DOWNLOAD_CONNECT_TIMEOUT_SECONDS <= FORMAT_DOWNLOAD_ATTEMPT_TIMEOUT_SECONDS )) ||
        fail "AGENTRY_FORMAT_DOWNLOAD_CONNECT_TIMEOUT_SECONDS must not exceed AGENTRY_FORMAT_DOWNLOAD_ATTEMPT_TIMEOUT_SECONDS"
    (( FORMAT_DOWNLOAD_ATTEMPT_TIMEOUT_SECONDS <= FORMAT_DOWNLOAD_TOTAL_TIMEOUT_SECONDS )) ||
        fail "AGENTRY_FORMAT_DOWNLOAD_ATTEMPT_TIMEOUT_SECONDS must not exceed AGENTRY_FORMAT_DOWNLOAD_TOTAL_TIMEOUT_SECONDS"
}
